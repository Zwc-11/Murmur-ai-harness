...
These adapters normalize public SDK traces/transcripts into Murmur's append-only
event log. They are intentionally observational: they do not execute tools or
judge outputs; they make an already-recorded trajectory analyzable by Murmur.
"""
