...
from chorus.report.agent_map_projector import plan_agent_map_from_task
...
def load_server_env(repo_root: Path) -> Path | None:
    """Load project `.env` for direct `python -m chorus.ui.server` launches."""
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--dir", type=Path, default=Path(".chorus/preview"))
