...
from chorus.report.ui_theme import document_close, document_head, hud_shell_start
...
"""
    script = f"""
window.CHORUS_PROOF = {payload_json};
"""
    head = document_head(title=f"Chorus Workbench - {proof.run_id}", extra_css=extra_css)
